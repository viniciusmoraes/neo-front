...
const DesktopCarrinhoCarrinhovazioPage = () => {
  const [inputvalue, setInputvalue] = React.useState("");

  return (
    <>
      <div className="bg-gray_50 flex flex-col font-rubik items-end justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-center w-[100%]">
          ...
          <div className="flex flex-col gap-[16px] h-[348px] md:h-[auto] items-center justify-center p-[24px] md:px-[20px] w-[364px]">
            ...
            <Text
              className="font-normal leading-[150.00%] md:max-w-[100%] max-w-[316px] not-italic text-bluegray_500 text-center"
              variant="body2"
            >
              Use a busca para encontrar um produto ou explore dentre os
              tratamentos disponíveis
            </Text>
          </div>
        </div>
        <div className="flex items-start justify-start max-w-[1151px] overflow-auto md:px-[20px] w-[100%]">
        ...
        <div className="flex items-center mt-[32px] sm:px-[20px] px-[310px] md:px-[40px] w-[100%]">
        ...
        <div className="bg-teal_800 flex h-[56px] md:h-[auto] items-center justify-center mr-[120px] mt-[32px] px-[16px] md:px-[20px] py-[14px] rounded-[28px] shadow-bs2 w-[auto]">
        ...
        <div className="flex items-center mt-[16px] w-[100%]">
...
export default DesktopCarrinhoCarrinhovazioPage;
