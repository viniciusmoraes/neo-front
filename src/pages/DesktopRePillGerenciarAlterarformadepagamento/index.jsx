...
const DesktopRePillGerenciarAlterarformadepagamentoPage = () => {
  return (
    <>
      <div className="bg-gray_100 flex font-rubik h-[1203px] justify-end mx-[auto] relative w-[100%]">
        <div className="h-[1506px] mt-[auto] mx-[auto] md:px-[20px] w-[100%]">
          <div className="flex md:flex-col flex-row md:gap-[20px] h-[100%] items-start justify-evenly m-[auto] w-[100%]">
            <div className="md:h-[1288px] h-[1506px] sm:h-[948px] relative md:w-[100%] w-[78%]">
              <Img
                src="images/img_ellipse14_3.png"
        ...
        <div className="absolute bg-bluegray_900_33 flex inset-x-[0] items-center justify-start mx-[auto] p-[173px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
          <div className="bg-white_A700 flex flex-col h-[306px] md:h-[auto] items-start justify-start mb-[245px] md:px-[20px] rounded-[8px] shadow-bs2 sm:w-[100%] w-[555px]">
            ...
            <div className="border-b-[1px] border-gray_300 border-solid flex flex-col gap-[16px] items-start justify-start p-[16px] sm:w-[100%] w-[555px]">
              <Input
...
export default DesktopRePillGerenciarAlterarformadepagamentoPage;
