...
import { Img, Input, Text, Line, Button, List, SelectBox } from "components";
import { CloseSVG } from "../../assets/images";
import { CircularProgressbar } from "react-circular-progressbar";
import "react-circular-progressbar/dist/styles.css";

const CategoriagridPage = () => {
    ...
    <>
      <div className="bg-gray_50 flex font-rubik items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start max-w-[1126px] mx-[auto] md:px-[20px] w-[100%]">
            ...
            <div className="flex flex-row gap-[16px] items-center justify-start py-[8px] w-[auto]">
              ...
              <div className="bg-white_A700 flex flex-row gap-[4px] items-center justify-center p-[4px] rounded-[8px] shadow-bs w-[auto]">
                ...
                <div className="flex items-center justify-center p-[4px] rounded-[4px] w-[32px]">
                  <div className="flex h-[24px] md:h-[auto] items-center justify-center w-[24px]">
                    <Img
                      src="images/img_menu_indigo_900_16x16.svg"
                      className="h-[16px] w-[16px]"
                      alt="menu"
                    />
                  </div>
          ...
          <div className="flex md:flex-col flex-row gap-[16px] items-start justify-start max-w-[1126px] mt-[16px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="bg-white_A700 flex flex-col items-start justify-start mb-[512px] md:mt-[0] mt-[5px] rounded-[16px] shadow-bs w-[270px]">
              <div className="flex h-[100%] items-start justify-start p-[24px] sm:px-[20px] w-[100%]">
                <Text
              ...
              <div className="border-b-[1px] border-gray_300 border-solid flex flex-col items-start justify-start sm:px-[20px] px-[24px] w-[100%]">
                ...
                <List
                  className="flex-col grid items-start pb-[16px] w-[100%]"
                  orientation="vertical"
                >
                  <div className="bg-white_A700 flex flex-1 items-start justify-center my-[0] px-[16px] py-[12px] w-[100%]">
            ...
            <div className="bg-white_A700 flex flex-1 flex-col h-[1245px] md:h-[auto] items-start justify-start max-w-[840px] rounded-[16px] shadow-bs w-[100%]">
              <div className="flex md:flex-col flex-row gap-[24px] items-center justify-center sm:px-[20px] px-[24px] w-[100%]">
                <div className="flex flex-col gap-[8px] items-start justify-start py-[24px]">
                  <div className="bg-deep_purple_50 h-[161px] relative rounded-[8px] w-[161px]">
                    <Img
                      src="images/img_imagem_161x161.png"
                      className="h-[161px] m-[auto] object-cover rounded-[8px] w-[161px]"
                      alt="Imagem One"
                    />
                    <div className="absolute bg-green_300 flex items-center justify-center px-[8px] py-[4px] right-[0] rounded-bl-[4px] rounded-br-[0] rounded-tl-[4px] rounded-tr-[0] top-[5%] w-[auto]">
                  ...
                  <div className="flex items-start justify-start w-[100%]">
                    <div className="flex flex-col gap-[4px] items-start justify-start w-[100%]">
                      ...
                      <div className="flex h-[26px] md:h-[auto] items-start justify-start w-[147px]">
                        <Text
                          className="text-bluegray_900 text-left w-[auto]"
                          as="h4"
                          variant="h4"
                ...
                <Img
                  src="images/img_miscdivider_gray_300.svg"
                  className="h-[100%] max-h-[384px] w-[auto] sm:w-[auto] md:w-[auto]"
                  alt="Miscdivider"
                />
                <div className="flex flex-1 flex-col gap-[8px] h-[100%] items-start justify-start py-[24px] w-[100%]">
                  <div className="bg-deep_purple_50 h-[161px] relative rounded-[8px] w-[161px]">
                    <Img
                      src="images/img_imagem_161x161.png"
                      className="h-[161px] m-[auto] object-cover rounded-[8px] w-[161px]"
                ...
                <Img
                  ...
                  alt="Miscdivider One"
                />
                <div className="flex flex-col gap-[8px] items-start justify-start py-[24px] w-[auto]">
                  <div className="bg-deep_purple_50 h-[161px] relative rounded-[8px] w-[161px]">
                    <Img
                      src="images/img_imagem_161x161.png"
                      className="h-[161px] m-[auto] object-cover rounded-[8px] w-[161px]"
          ...
          <div className="bg-white_A700 flex flex-row gap-[8px] h-[44px] md:h-[auto] items-center justify-center ml-[auto] mt-[16px] px-[16px] md:px-[20px] py-[8px] rounded-[4px] shadow-bs w-[auto]">
            <Button
...
export default CategoriagridPage;
