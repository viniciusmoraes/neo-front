...
const DesktopCheckoutPagamentocartosalvoPage = () => {
      ...
      <div className="bg-gray_50 flex font-rubik items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row gap-[16px] items-start justify-center max-w-[936px] mt-[16px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="bg-white_A700 flex sm:flex-1 flex-col gap-[16px] items-end justify-start mb-[53px] p-[16px] rounded-[8px] shadow-bs sm:w-[100%] w-[555px]">
              <div className="flex h-[72px] md:h-[auto] items-start justify-center py-[12px] rounded-[8px] w-[100%]">
                <div className="flex sm:flex-col flex-row gap-[16px] items-center justify-start w-[100%]">
                  ...
                  <div className="md:h-[29px] h-[44px] relative w-[100%]">
                    <div className="absolute flex items-start justify-start left-[0] top-[0] w-[192px]">
                      <Text
                    ...
                    <div className="absolute bottom-[0] md:h-[29px] h-[36px] inset-x-[0] mx-[auto] w-[100%]">
                      <div className="absolute bottom-[0] flex inset-x-[0] items-center justify-start mx-[auto] pb-[4px] sm:w-[100%] w-[483px]">
                        <Text
                      ...
                      <div className="absolute bg-light_green_A200 flex items-center justify-center px-[8px] py-[4px] right-[0] rounded-[4px] top-[0] w-[auto]">
              ...
              <Button
                className="flex items-center justify-center min-w-[148px] text-center w-[auto]"
                leftIcon={
                  <Img
          ...
          <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between max-w-[1151px] mt-[16px] mx-[auto] md:px-[20px] w-[100%]">
            <Img
              src="images/img_image45.png"
              className="md:flex-1 h-[290px] sm:h-[auto] md:mt-[0] mt-[203px] object-cover md:w-[100%] w-[auto]"
              alt="imageFortyFive"
            />
            <div className="flex md:flex-1 flex-col gap-[32px] items-center justify-start mb-[130px] md:w-[100%] w-[auto]">
...
export default DesktopCheckoutPagamentocartosalvoPage;
