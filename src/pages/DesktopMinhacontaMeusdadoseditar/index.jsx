...
import { Img, Input, Text, Line, SelectBox, Button } from "components";
import { CloseSVG } from "../../assets/images";
import { CircularProgressbar } from "react-circular-progressbar";
import "react-circular-progressbar/dist/styles.css";

const DesktopMinhacontaMeusdadoseditarPage = () => {
    ...
    <>
      <div className="bg-gray_100 flex flex-col font-rubik items-center justify-end mx-[auto] w-[100%]">
        ...
        <div className="flex md:px-[20px] relative w-[100%]">
          ...
          <div className="flex flex-col gap-[32px] justify-start ml-[undefinedpx] mr-[120px] mt-[16px] w-[62%] z-[1]">
            <div className="flex flex-col gap-[16px] justify-start mr-[16px] md:w-[100%] w-[99%]">
              ...
              <div className="flex md:flex-col flex-row gap-[16px] items-start justify-between md:ml-[0] ml-[16px] md:w-[100%] w-[99%]">
                <div className="bg-white_A700 flex flex-col items-end justify-end p-[16px] rounded-[8px] shadow-bs sm:w-[100%] w-[396px]">
                  ...
                  <div className="gap-[16px] grid grid-cols-2 justify-center min-h-[auto] w-[100%]">
                    ...
                    <div className="flex flex-1 flex-col gap-[8px] items-start justify-start pb-[16px] pt-[8px] w-[100%]">
                      <div className="flex items-center justify-start w-[100%]">
                        <div className="flex items-start justify-start w-[auto]">
                          <Text
                            className="font-medium text-bluegray_800 text-left w-[auto]"
                ...
                <div className="bg-white_A700 flex flex-col items-start justify-start mb-[174px] p-[16px] rounded-[8px] shadow-bs sm:w-[100%] w-[396px]">
                  <div className="flex items-start justify-start pb-[16px] pt-[8px] w-[100%]">
                    <Text
                      className="text-bluegray_900 text-left w-[auto]"
                      as="h3"
                  ...
                  <div className="flex flex-row items-center justify-start w-[100%]">
                    <div className="flex flex-1 items-start justify-start pt-[8px] w-[100%]">
                    ...
                    <Button
                      className="flex items-center justify-center min-w-[131px] text-center w-[auto]"
                      leftIcon={
                        <Img
            ...
            <div className="bg-teal_800 flex h-[56px] md:h-[auto] items-center justify-center md:ml-[0] ml-[653px] px-[16px] py-[14px] rounded-[28px] shadow-bs2 w-[auto]">
          ...
          <footer className="bg-bluegray_900 flex md:flex-col flex-row gap-[32px] items-center justify-center mb-[257px] ml-[-390px] mr-[auto] mt-[auto] px-[120px] sm:px-[20px] md:px-[40px] py-[48px] w-[100%] z-[1]">
...
export default DesktopMinhacontaMeusdadoseditarPage;
