...
const FaqPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_100 flex flex-col font-rubik justify-start mx-[auto] w-[100%]">
        <div className="flex items-center w-[100%]">
          <div className="h-[76px] md:px-[20px] relative w-[100%]">
            <Img
              src="images/img_refresh.svg"
              className="absolute h-[20px] right-[39%] top-[21%] w-[auto]"
              alt="refresh"
            />
            <Img
              src="images/img_refresh.svg"
              className="absolute h-[20px] right-[38%] top-[33%] w-[auto]"
              alt="refresh One"
            />
            <div className="absolute bg-gray_50 flex h-[100%] inset-[0] items-center justify-start m-[auto] max-w-[1366px] px-[120px] sm:px-[20px] md:px-[40px] py-[8px] shadow-bs w-[100%]">
        ...
        <div className="flex items-start justify-start md:ml-[0] ml-[120px] mt-[20px] md:px-[20px] w-[auto]">
        ...
        <div className="flex flex-col items-center mt-[32px] w-[100%]">
          <div className="bg-white_A700 flex items-center justify-start max-w-[1126px] mx-[auto] md:px-[20px] rounded-[16px] w-[100%]">
            <div
              className="bg-cover bg-indigo_900 bg-no-repeat flex h-[410px] items-start justify-center p-[95px] sm:px-[20px] md:px-[40px] rounded-[16px] w-[100%]"
          ...
          <div className="flex items-center justify-start mt-[32px] md:px-[20px] md:w-[100%] w-[55%]">
          ...
          <div className="flex items-start justify-start mt-[32px] md:px-[20px] md:w-[100%] w-[auto]">
              ...
              <div className="bg-white_A700 flex flex-col gap-[16px] items-center justify-center max-w-[745px] rounded-[8px] shadow-bs w-[100%]">
                ...
                <div className="bg-deep_purple_50 flex items-start justify-center p-[16px] w-[100%]">
                  ...
                  >
                    ...
                    medicamentos e produtos farmacêuticos sem precisar enfrentar
                    filas como nas farmácias tradicionais! Entregamos o seu
                    pedido rapidamente no endereço que você preferir.
                    <br />
                    <br />
                      ...
                      <div className="absolute flex flex-1 inset-x-[0] items-start justify-start mx-[auto] top-[8%] w-[100%]">
                        <div className="flex items-start justify-start sm:w-[100%] w-[auto]">
                          <Text
                            ...
                            variant="h6"
                          >
                            Posso usar o desconto do meu plano de saúde na Pill?
                          </Text>
                        </div>
                      </div>
                      <Img
          ...
          <div className="flex items-center justify-start mt-[49px] md:px-[20px] md:w-[100%] w-[55%]">
