...
const DesktopCheckoutPagamentoPIXPage = () => {
      ...
      <div className="bg-gray_50 flex font-rubik items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row gap-[16px] items-start justify-center max-w-[936px] mt-[16px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="bg-white_A700 flex sm:flex-1 flex-col gap-[16px] items-center justify-center pt-[24px] rounded-[8px] shadow-bs sm:w-[100%] w-[555px]">
              ...
              <Text
                ...
                variant="h5"
              >
                Pedido nº 1234 aguardando pagamento
              </Text>
              <Text
                className="font-normal leading-[150.00%] md:max-w-[100%] max-w-[523px] not-italic text-bluegray_500 text-center"
                variant="body2"
              >
                Realize o pagamento com o código abaixo para concluir seu
                pedido. Você receberá a confirmação por e-mail.{" "}
              </Text>
              <div className="flex flex-col gap-[16px] items-center justify-start w-[100%]">
                <div className="flex sm:flex-col flex-row gap-[16px] items-center justify-center p-[16px] w-[100%]">
                  <Img
                    src="images/img_qrcode_indigo_900.svg"
                    className="h-[175px] w-[175px]"
                    alt="qrcode"
                  />
                  <div className="flex flex-1 flex-col gap-[16px] h-[100%] items-start justify-center py-[16px] w-[100%]">
                    <div className="flex items-start justify-start w-[320px]">
                      <div className="bg-white_A700 border-[1px] border-gray_300 border-solid flex items-start justify-center p-[12px] rounded-[8px] w-[100%]">
                        <div className="flex items-center justify-start w-[100%]">
                          <div className="flex items-center justify-start px-[4px] w-[100%]">
                            <Text
                              className="font-normal leading-[150.00%] md:max-w-[100%] max-w-[288px] not-italic text-bluegray_800 text-left"
                              variant="body1"
                            >
                              18bcf438-014c-4d45-bb02-f85a9cc8965e18bcf438-014c-4d45-bb02-f85a9cc8965e
                            </Text>
                          </div>
                        </div>
                      </div>
                    ...
                    <Button
                      className="flex items-center justify-center min-w-[161px] text-center w-[auto]"
                      leftIcon={
                        <Img
                ...
                <div className="bg-yellow_200 flex items-start justify-start p-[16px] w-[100%]">
            ...
            <div className="flex md:flex-1 flex-col gap-[16px] items-center justify-start md:w-[100%] w-[39%]">
              ...
              <div className="flex h-[44px] md:h-[auto] items-center justify-center rounded-[22px] w-[328px]">
...
export default DesktopCheckoutPagamentoPIXPage;
