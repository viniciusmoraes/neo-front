        ...
        <div className="bg-gray_50 flex items-center justify-start w-[100%]">
          <div className="flex flex-col items-center justify-start w-[100%]">
            ...
            <div className="flex md:flex-col flex-row gap-[16px] items-start justify-start max-w-[1126px] mt-[8px] mx-[auto] md:px-[20px] w-[100%]">
              <div className="bg-white_A700 flex flex-col items-start justify-start mb-[51px] rounded-[16px] shadow-bs w-[270px]">
                ...
                <div className="border-b-[1px] border-gray_300 border-solid flex flex-col items-start justify-start sm:px-[20px] px-[24px] w-[100%]">
                  ...
                  >
                    ...
                    <div className="bg-white_A700 flex flex-1 items-start justify-center my-[0] px-[16px] py-[12px] w-[100%]">
                      <div className="flex flex-row gap-[16px] items-center justify-start w-[100%]">
                        <Img
                          src="images/img_lefticon_gray_500.svg"
                          className="h-[24px] w-[24px]"
                          alt="lefticon"
                        />
                        <div className="flex flex-1 items-start justify-start w-[100%]">
            ...
            <div className="bg-bluegray_900 flex md:flex-col flex-row gap-[32px] items-start justify-start max-w-[1366px] mt-[152px] px-[120px] sm:px-[20px] md:px-[40px] py-[48px] w-[100%]">
...
export default CategorialistaPage;
