...
import { Img, Input, Text, Line, SelectBox, CheckBox } from "components";
import { CloseSVG } from "../../assets/images";
import { CircularProgressbar } from "react-circular-progressbar";
import "react-circular-progressbar/dist/styles.css";

const CadastropessoafisicaPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_100 flex flex-col font-rubik items-end justify-start mx-[auto] w-[100%]">
        ...
        <div className="md:h-[836px] h-[940px] sm:h-[944px] mt-[16px] md:px-[20px] relative md:w-[100%] w-[71%]">
            ...
            <div className="absolute flex h-[100%] inset-[0] items-center justify-center m-[auto] w-[100%]">
              <div className="h-[356px] relative w-[100%]">
                <div className="h-[356px] m-[auto] w-[100%]">
                  ...
                  />
                  <Img
                    src="images/img_mask_356x276.png"
...
export default CadastropessoafisicaPage;
