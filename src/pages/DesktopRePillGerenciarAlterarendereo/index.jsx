...
import { Img, Button, Text, List, Input, SelectBox } from "components";
import { CircularProgressbar } from "react-circular-progressbar";
import "react-circular-progressbar/dist/styles.css";

const DesktopRePillGerenciarAlterarendereoPage = () => {
  return (
    <>
      <div className="bg-gray_100 flex font-rubik h-[1203px] justify-end mx-[auto] relative w-[100%]">
        <div className="h-[1506px] mt-[auto] mx-[auto] md:px-[20px] w-[100%]">
          <div className="flex md:flex-col flex-row md:gap-[20px] h-[100%] items-start justify-evenly m-[auto] w-[100%]">
            <div className="md:h-[1288px] h-[1506px] sm:h-[948px] relative md:w-[100%] w-[78%]">
              <Img
                src="images/img_ellipse14_4.png"
        ...
        <div className="absolute bg-bluegray_900_33 flex inset-x-[0] items-center justify-end mx-[auto] p-[160px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
          <div className="bg-white_A700 flex flex-col h-[564px] md:h-[auto] items-start justify-start mt-[13px] md:px-[20px] rounded-[8px] shadow-bs2 sm:w-[100%] w-[555px]">
            ...
            <div className="border-b-[1px] border-gray_300 border-solid flex flex-col gap-[8px] items-start justify-start p-[16px] sm:w-[100%] w-[555px]">
              ...
              >
                <div className="flex flex-1 sm:flex-col flex-row gap-[8px] items-start justify-start w-[100%]">
              ...
              <div className="flex items-center justify-center py-[4px]">
                <Text
                  className="font-normal h-[17px] not-italic text-bluegray_800 text-left w-[auto]"
                  variant="body1"
                >
                  ou
                </Text>
              ...
              <div className="flex items-start justify-start w-[100%]">
                <SelectBox
                  className="font-normal h-[48px] not-italic px-[12px] text-[14px] text-bluegray_800 text-left w-[100%]"
                  placeholderClassName="text-bluegray_800"
                  name="FormsFieldoutlinedefault"
                  placeholder="Selecionar outra opção..."
                  isSearchable={false}
                  isMulti={false}
                  indicator={
                    <Img
              ...
              <List
                className="sm:flex-col flex-row gap-[8px] grid sm:grid-cols-1 grid-cols-2 justify-start pb-[8px] w-[100%]"
                orientation="horizontal"
              >
                <div className="border-[1px] border-indigo_900 border-solid flex flex-1 flex-col items-center justify-start p-[12px] rounded-[8px] w-[100%]">
            ...
            <div className="bg-gray_500 flex h-[44px] md:h-[auto] items-center justify-center px-[16px] py-[14px] rounded-[22px] w-[290px]">
              <div className="flex items-center justify-center w-[auto]">
                <div className="flex items-center justify-center px-[4px] w-[auto]">
                  <Text
                    className="font-medium text-center text-gray_100 w-[auto]"
                    variant="body1"
                  >
                    Alterar
                  </Text>
...
export default DesktopRePillGerenciarAlterarendereoPage;
