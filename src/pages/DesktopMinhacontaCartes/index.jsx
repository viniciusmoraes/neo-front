...
const DesktopMinhacontaCartesPage = () => {
        ...
        <div className="flex md:px-[20px] relative w-[100%]">
          ...
          <div className="flex flex-col items-end justify-start ml-[undefinedpx] mr-[120px] mt-[16px] w-[62%] z-[1]">
            <div className="flex flex-col gap-[16px] items-start justify-start w-[100%]">
              ...
              >
                <div className="bg-white_A700 flex sm:flex-1 flex-col items-start justify-start my-[0] p-[16px] rounded-[8px] shadow-bs sm:w-[100%] w-[396px]">
                  ...
                  <div className="flex flex-row gap-[16px] items-center justify-start pb-[16px] pt-[8px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-1 flex-col gap-[16px] items-end justify-end my-[0] p-[16px] rounded-[8px] shadow-bs w-[100%]">
                  ...
                  <div className="flex items-start justify-start w-[100%]">
                    <div className="border-[1px] border-gray_300 border-solid flex flex-col items-start justify-start px-[16px] py-[12px] rounded-[8px] w-[100%]">
                      <div className="flex flex-row gap-[16px] items-center justify-start w-[100%]">
                        <Img
          ...
          <footer className="bg-bluegray_900 flex md:flex-col flex-row gap-[32px] items-center justify-center mb-[148px] ml-[-390px] mr-[auto] mt-[auto] px-[120px] sm:px-[20px] md:px-[40px] py-[48px] w-[100%] z-[1]">
...
export default DesktopMinhacontaCartesPage;
