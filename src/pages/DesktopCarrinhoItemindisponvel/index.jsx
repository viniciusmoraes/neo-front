...
const DesktopCarrinhoItemindisponvelPage = () => {
      ...
      <div className="bg-gray_50 flex font-rubik items-center justify-end mx-[auto] w-[100%]">
        <div className="flex flex-col items-start justify-end w-[100%]">
          ...
          <div className="flex md:flex-col flex-row gap-[16px] items-start justify-start mr-[auto] md:px-[20px] md:w-[100%] w-[92%]">
            <div className="h-[1142px] md:h-[1297px] sm:h-[697px] relative md:w-[100%] w-[70%]">
              <Img
              ...
              <div className="absolute flex flex-col gap-[16px] items-start justify-start py-[32px] right-[0] top-[0] w-[auto]">
                ...
                <div className="flex flex-col items-end justify-start max-w-[745px] shadow-bs w-[100%]">
                  ...
                  <div className="bg-white_A700 flex flex-col items-center justify-center rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
                    ...
                    <div className="flex flex-col gap-[8px] items-start justify-center pb-[16px] px-[16px] w-[100%]">
                      <div className="flex md:flex-col flex-row gap-[16px] items-start justify-end py-[16px] w-[100%]">
                        <div className="flex flex-1 flex-col gap-[8px] items-start justify-start w-[100%]">
                          ...
                          <Button
                            className="flex items-center justify-center min-w-[107px] text-center w-[auto]"
                            leftIcon={
                              <Img
                                src="images/img_icon_red_600.svg"
                        ...
                        <div className="flex flex-row font-acuminpro gap-[12px] items-center justify-center w-[163px]">
                          ...
                          <div className="bg-white_A700 border-[1px] border-bluegray_300 border-solid flex h-[48px] md:h-[auto] items-center justify-center p-[12px] rounded-[8px] w-[100%]">
                            <div className="flex items-center justify-center w-[auto]">
                      ...
                      <div className="flex flex-col items-start justify-start w-[100%]">
                        ...
                        <Input
                          ...
                          wrapClassName="w-[100%]"
                          name="Seo"
                          placeholder="Você pode substituir por:"
                          shape="CustomBorderTL8"
                          size="sm"
                          variant="FillGray900"
                        ></Input>
                        <List
                          className="bg-white_A700 border-b-[1px] border-gray_300 border-solid border-x-[1px] flex-col md:gap-[20px] grid items-start rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[0] w-[100%]"
                          orientation="vertical"
                        >
                          <div className="border-b-[1px] border-gray_300 border-solid flex flex-1 md:flex-col flex-row gap-[16px] items-start justify-end my-[0] sm:px-[20px] px-[24px] py-[16px] w-[100%]">
                            <div className="flex flex-1 items-start justify-start w-[100%]">
                            ...
                            <div className="bg-green_300 flex h-[32px] md:h-[auto] items-center justify-center px-[8px] rounded-[4px] w-[auto]">
                          ...
                          <div className="flex flex-1 md:flex-col flex-row gap-[16px] items-start justify-end my-[0] sm:px-[20px] px-[24px] py-[16px] w-[100%]">
                            <div className="flex flex-1 items-start justify-start w-[100%]">
                              <div className="border-b-[1px] border-gray_300 border-solid flex items-start justify-center w-[100%]">
                                <div className="flex flex-row gap-[16px] items-center justify-start w-[auto]">
                                  <div className="flex h-[40px] items-center justify-start rounded-[8px] w-[40px]">
            ...
            <div className="flex flex-col md:mt-[0] mt-[86px] relative md:w-[100%] w-[30%]">
              <div className="flex flex-col gap-[21px] items-center justify-start m-[auto] w-[auto]">
                <div className="bg-white_A700 flex flex-col items-start justify-start p-[16px] rounded-[8px] shadow-bs w-[365px]">
                  ...
                  <Input
                    className="font-normal not-italic p-[0] text-[14px] placeholder:text-green_800 text-green_800 text-left w-[100%]"
                    wrapClassName="w-[100%]"
                    name="Itemmobile"
                    placeholder="Oba! Entregamos nessa região :)"
                    shape="RoundedBorder8"
                    size="md"
                    variant="FillLightgreen50"
                  ></Input>
                  <div className="bg-white_A700 flex h-[72px] md:h-[auto] items-start justify-center py-[12px] w-[100%]">
                      ...
                      <div className="flex flex-1 flex-col items-start justify-center w-[100%]">
                        ...
                        <div className="flex items-center justify-center w-[auto]">
                          <Text
                            ...
                            variant="body2"
                          >
                            Selecione a data na próxima etapa
                          </Text>
                        </div>
                      </div>
                    </div>
          ...
          <footer className="bg-bluegray_900 flex md:flex-col flex-row gap-[32px] items-center justify-center px-[120px] md:px-[20px] py-[48px] w-[100%]">
            ...
            <div className="h-[211px] relative md:w-[100%] w-[56%]">
              ...
              <Button
                className="absolute bottom-[15%] flex items-center justify-center min-w-[359px] right-[8%] text-center w-[auto]"
                leftIcon={
                  <Img
                    src="images/img_checkmark_green_400.svg"
                    className="mr-[8px] text-center right-[1%] absolute"
                    alt="checkmark"
                  />
                }
                shape="RoundedBorder8"
              ...
              >
                <div className="bg-transparent cursor-pointer font-normal not-italic text-[14px] text-bluegray_800 text-left">
                  Cupom BEMVINDO10 adicionado com sucesso
                </div>
              </Button>
            </div>
            <div className="flex flex-1 items-start justify-start w-[100%]">
...
export default DesktopCarrinhoItemindisponvelPage;
