...
const DesktopMinhacontaHistricodepedidosOnePage = () => {
  ...
  return (
    <>
      <div className="bg-gray_100 flex flex-col font-rubik items-center justify-start mx-[auto] w-[100%]">
        ...
        <div className="h-[1241px] sm:h-[307px] md:h-[878px] md:px-[20px] relative w-[100%]">
          <div className="absolute bg-white_A700 flex flex-col md:h-[auto] h-[max-content] inset-y-[0] items-start justify-start left-[0] my-[auto] pl-[120px] sm:pl-[20px] md:pl-[40px] pt-[24px] sm:w-[100%] w-[390px]">
          ...
          <div className="absolute flex flex-col items-start justify-start right-[9%] top-[1%] w-[62%]">
            ...
            <div className="flex md:flex-col flex-row gap-[8px] items-center justify-between max-w-[840px] p-[16px] w-[100%]">
              <div className="flex sm:flex-1 items-start justify-start sm:w-[100%] w-[328px]">
                <Input
                  className="font-normal not-italic p-[0] text-[14px] placeholder:text-gray_500 text-gray_500 text-left w-[100%]"
            ...
            <List
              className="flex-col gap-[16px] grid items-start max-w-[840px] p-[16px] w-[100%]"
              orientation="vertical"
            >
              <div className="bg-white_A700 flex flex-1 flex-col items-start justify-start my-[0] p-[16px] rounded-[8px] shadow-bs w-[100%]">
                <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start w-[100%]">
                  <div className="flex flex-1 h-[100%] items-start justify-start py-[8px] w-[100%]">
                    <Text
                      className="font-medium text-bluegray_800 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                ...
                <div className="flex md:flex-col flex-row gap-[16px] items-center justify-start py-[8px] w-[100%]">
                  ...
                  <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                    <div className="border-[1px] border-gray_100 border-solid flex h-[56px] items-center justify-start rounded-[8px] w-[56px]">
                      <Img
                        src="images/img_imagem_56x56.png"
                        className="h-[56px] md:h-[auto] object-cover rounded-[8px] w-[56px]"
                        alt="Imagem One"
                      />
                    </div>
                    <div className="border-[1px] border-gray_100 border-solid flex h-[56px] items-center justify-start rounded-[8px] w-[56px]">
              ...
              <div className="bg-white_A700 flex flex-1 flex-col items-start justify-start my-[0] p-[16px] rounded-[8px] shadow-bs w-[100%]">
                ...
                <div className="flex md:flex-col flex-row gap-[16px] items-center justify-start py-[8px] w-[100%]">
                  ...
                  <div className="flex flex-1 flex-row gap-[8px] items-center justify-end w-[100%]">
                    <div className="border-[1px] border-gray_100 border-solid flex h-[56px] items-center justify-start rounded-[8px] w-[56px]">
                      <Img
                        src="images/img_imagem_56x56.png"
                        className="h-[56px] md:h-[auto] object-cover rounded-[8px] w-[56px]"
            ...
            <div className="bg-teal_800 flex h-[56px] md:h-[auto] items-center justify-center md:ml-[0] ml-[653px] mt-[16px] px-[16px] py-[14px] rounded-[28px] shadow-bs2 w-[auto]">
...
export default DesktopMinhacontaHistricodepedidosOnePage;
