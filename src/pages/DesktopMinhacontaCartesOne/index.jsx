...
const DesktopMinhacontaCartesOnePage = () => {
    ...
    <>
      <div className="bg-gray_100 flex flex-col font-rubik items-center justify-end mx-[auto] w-[100%]">
        ...
        <div className="flex md:px-[20px] relative w-[100%]">
          ...
          <div className="flex flex-col gap-[32px] justify-start ml-[undefinedpx] mr-[120px] mt-[16px] w-[63%] z-[1]">
            <div className="flex flex-col justify-start mr-[16px] md:w-[100%] w-[99%]">
              <div className="flex flex-col gap-[8px] items-start justify-start md:ml-[0] ml-[16px] px-[16px] w-[auto]">
              ...
              <div className="flex h-[410px] md:h-[auto] items-start justify-start max-w-[840px] p-[16px] w-[100%]">
                  ...
                  <div className="bg-white_A700 flex flex-col gap-[16px] h-[100%] items-center justify-center px-[16px] py-[24px] rounded-[8px] shadow-bs w-[100%]">
                    ...
                    <div className="flex items-start justify-start w-[auto]">
                      <Text
                        ...
                        variant="h5"
                      >
                        Você ainda não cadastrou um cartão
                      </Text>
                    </div>
                    <Text
                      ...
                      variant="body2"
                    >
                      Você pode adicionar um cartão antes ou depois de começar
                      as compras!
                    </Text>
            ...
            <div className="bg-teal_800 flex h-[56px] md:h-[auto] items-center justify-center md:ml-[0] ml-[669px] px-[16px] py-[14px] rounded-[28px] shadow-bs2 w-[auto]">
          ...
          <footer className="bg-bluegray_900 flex md:flex-col flex-row gap-[32px] items-center justify-center mb-[278px] ml-[-390px] mr-[auto] mt-[auto] px-[120px] sm:px-[20px] md:px-[40px] py-[48px] w-[100%] z-[1]">
...
export default DesktopMinhacontaCartesOnePage;
