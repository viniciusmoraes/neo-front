...
const SemresultadosPage = () => {
  const [inputvalue, setInputvalue] = React.useState("");

  return (
    <>
      <div className="bg-gray_50 flex flex-col font-rubik items-start justify-start mx-[auto] w-[100%]">
        ...
        <div className="flex items-end mt-[32px] sm:pl-[20px] pl-[215px] md:pl-[40px] w-[100%]">
          <div className="md:h-[767px] h-[791px] relative w-[100%]">
            <Img
              src="images/img_group145.png"
              className="absolute h-[767px] inset-y-[0] my-[auto] object-cover right-[0] w-[auto]"
              alt="Group145"
            />
            <div className="absolute flex flex-col gap-[16px] items-center justify-center left-[17%] p-[24px] sm:px-[20px] top-[0] sm:w-[100%] w-[555px]">
              ...
              <Text
                ...
                variant="body2"
              >
                Revise a ortografia ou navegue pelas categorias para encontrar o
                que você precisa.
              </Text>
            </div>
            <div className="absolute bottom-[37%] flex items-center justify-start left-[0] max-w-[1000px] w-[100%]">
              <div className="flex flex-col gap-[8px] items-start justify-start md:w-[100%] w-[auto]">
                ...
                <List
                  className="sm:flex-col flex-row gap-[8px] grid sm:grid-cols-1 md:grid-cols-4 grid-cols-8 justify-start md:w-[100%] w-[auto]"
            ...
            <div className="absolute bottom-[9%] flex items-center justify-start left-[8%] w-[65%]">
        ...
        <div className="flex items-center mt-[50px] w-[100%]">
...
export default SemresultadosPage;
