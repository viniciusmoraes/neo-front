...
const DesktopCheckoutConclusocartoPage = () => {
    ...
    <>
      <div className="bg-gray_50 flex font-rubik items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row gap-[18px] items-center justify-center max-w-[936px] mt-[16px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="bg-white_A700 flex sm:flex-1 flex-col gap-[16px] h-[370px] md:h-[auto] items-center justify-center px-[16px] py-[24px] rounded-[8px] shadow-bs sm:w-[100%] w-[553px]">
...
export default DesktopCheckoutConclusocartoPage;
