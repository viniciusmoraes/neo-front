...
const LoginrecuperacaodesenhaPage = () => {
    ...
    <>
      <div className="bg-gray_100 flex flex-col font-rubik justify-start mx-[auto] w-[100%]">
        ...
        <div className="flex items-end mt-[16px] sm:px-[20px] md:px-[40px] px-[61px] w-[100%]">
          <div className="md:h-[334px] h-[460px] relative md:w-[100%] w-[73%]">
            ...
            <div className="absolute bg-white_A700 flex flex-col gap-[8px] items-center justify-start left-[0] p-[24px] sm:px-[20px] rounded-[8px] shadow-bs top-[0] sm:w-[100%] w-[555px]">
              ...
              <div className="flex items-end justify-start pt-[16px] w-[100%]">
                <div className="bg-gray_500 flex h-[44px] md:h-[auto] items-center justify-center px-[16px] py-[14px] rounded-[22px] w-[auto]">
...
export default LoginrecuperacaodesenhaPage;
