...
const DesktopMinhacontaEndereosPage = () => {
                ...
                <div className="flex h-[100%] items-start justify-start p-[16px] w-[100%]">
                  <div className="bg-white_A700 flex flex-col gap-[16px] h-[100%] items-center justify-center px-[16px] py-[24px] rounded-[8px] shadow-bs w-[100%]">
                    ...
                    <Text
                      ...
                      variant="body2"
                    >
                      Você pode adicionar um endereço antes ou depois de começar
                      as compras!
                    </Text>
...
export default DesktopMinhacontaEndereosPage;
