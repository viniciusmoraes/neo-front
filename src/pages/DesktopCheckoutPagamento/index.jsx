...
const DesktopCheckoutPagamentoPage = () => {
    ...
    <>
      <div className="bg-gray_50 flex font-rubik items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-start justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row gap-[15px] items-start justify-start mt-[16px] md:px-[20px] md:w-[100%] w-[85%]">
            <div className="flex flex-col gap-[282px] md:gap-[40px] justify-start md:w-[100%] w-[67%]">
              <div className="flex flex-col gap-[16px] items-center justify-start md:ml-[0] ml-[215px] md:w-[100%] w-[73%]">
                <Input
              ...
              <Img
                ...
                className="h-[290px] md:h-[auto] mr-[190px] object-cover w-[76%]"
                alt="imageFortyFive"
              />
            </div>
            <div className="flex flex-col gap-[32px] items-center justify-start md:w-[100%] w-[32%]">
              ...
              <div className="bg-gray_300 flex h-[44px] md:h-[auto] items-center justify-center px-[16px] py-[14px] rounded-[22px] w-[365px]">
                <div className="flex items-center justify-start w-[auto]">
                  <div className="flex items-center justify-center w-[auto]">
                    <Text
...
export default DesktopCheckoutPagamentoPage;
