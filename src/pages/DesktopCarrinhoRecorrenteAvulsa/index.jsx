...
const DesktopCarrinhoRecorrenteAvulsaPage = () => {
      ...
      <div className="bg-gray_50 flex font-rubik items-center justify-end mx-[auto] w-[100%]">
        <div className="flex flex-col items-start justify-end w-[100%]">
          ...
          <div className="flex md:flex-col flex-row gap-[16px] items-start justify-start mr-[auto] md:px-[20px] md:w-[100%] w-[92%]">
            <div className="flex flex-col gap-[111px] md:gap-[40px] justify-start md:w-[100%] w-[70%]">
              <div className="flex flex-col gap-[16px] items-start justify-start md:ml-[0] ml-[120px] py-[32px] md:w-[100%] w-[auto]">
                ...
                >
                  <div className="flex flex-1 flex-col items-end justify-start max-w-[745px] shadow-bs w-[100%]">
                  ...
                  <div className="flex flex-1 flex-col items-center justify-start max-w-[745px] shadow-bs w-[100%]">
              ...
              <Img
                ...
                className="h-[289px] sm:h-[auto] object-cover md:w-[100%] w-[68%]"
                alt="imageFortyFour"
              />
            </div>
...
export default DesktopCarrinhoRecorrenteAvulsaPage;
