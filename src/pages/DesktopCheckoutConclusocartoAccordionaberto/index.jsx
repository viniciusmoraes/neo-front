...
const DesktopCheckoutConclusocartoAccordionabertoPage = () => {
    ...
    <>
      <div className="bg-gray_50 flex font-rubik items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row gap-[18px] items-start justify-center max-w-[936px] mt-[16px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="bg-white_A700 flex sm:flex-1 flex-col gap-[16px] h-[370px] md:h-[auto] items-center justify-center mb-[323px] px-[16px] py-[24px] rounded-[8px] shadow-bs sm:w-[100%] w-[553px]">
              ...
              <div className="flex items-start justify-start w-[auto]">
                <Text
                  ...
                  variant="h5"
                >
                  Pedido nº 1234 em processamento
                </Text>
              </div>
              <Text
                ...
                variant="body2"
              >
                Estamos processando o pagamento. Você receberá a confirmação por
                e-mail.
              </Text>
            </div>
            <div className="flex md:flex-1 flex-col items-center justify-start md:w-[100%] w-[39%]">
              <div className="flex items-end justify-start rounded-[8px] shadow-bs w-[365px]">
                <div className="bg-indigo_900 h-[58px] p-[16px] relative rounded-[8px] w-[100%]">
                  <div className="flex flex-row gap-[8px] h-[100%] items-center justify-start m-[auto] w-[92%]">
                  ...
                  <div className="absolute bg-indigo_900 flex flex-row gap-[8px] h-[100%] inset-[0] items-center justify-start m-[auto] p-[16px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] w-[365px]">
                    <div className="flex items-start justify-start w-[100%]">
                      <Text
                        className="text-left text-light_green_A200 w-[auto]"
                        as="h3"
              ...
              <div className="bg-white_A700 flex flex-col items-center justify-center rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[0] w-[365px]">
              ...
              <div className="bg-white_A700 flex flex-col items-start justify-start mt-[16px] pt-[8px] rounded-[8px] shadow-bs w-[365px]">
              ...
              <div className="flex h-[44px] md:h-[auto] items-center justify-center mt-[16px] rounded-[22px] w-[328px]">
            ...
            <div className="flex flex-1 items-start justify-start w-[100%]">
              <div className="flex items-start justify-start w-[100%]">
                <div className="md:h-[56px] h-[78px] pb-[8px] pt-[16px] px-[8px] relative w-[100%]">
                  ...
                  <div className="absolute bg-teal_800 flex h-[56px] md:h-[auto] items-center justify-center px-[16px] py-[14px] right-[0] rounded-[28px] shadow-bs2 top-[4%] w-[auto]">
...
export default DesktopCheckoutConclusocartoAccordionabertoPage;
