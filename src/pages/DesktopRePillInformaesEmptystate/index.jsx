...
const DesktopRePillInformaesEmptystatePage = () => {
  const [inputvalue, setInputvalue] = React.useState("");

  return (
    <>
      <div className="bg-gray_100 flex flex-col font-rubik gap-[16px] items-start justify-start mx-[auto] w-[100%]">
        ...
        <div className="flex flex-col gap-[8px] items-start justify-start md:ml-[0] ml-[310px] md:px-[20px] w-[281px]">
        ...
        <div className="flex items-center w-[100%]">
          <div className="h-[1264px] md:h-[925px] md:px-[20px] relative w-[100%]">
            <Img
              src="images/img_vetores.png"
              className="absolute bottom-[15%] h-[280px] left-[0] object-cover w-[auto]"
              alt="Vetores"
            />
            ...
            <div className="absolute flex flex-col gap-[33px] justify-start right-[0] top-[0] w-[78%]">
              <div className="flex flex-col gap-[32px] items-start justify-start max-w-[1056px] py-[16px] w-[100%]">
                <div className="flex items-start justify-start md:w-[100%] w-[auto]">
                  <div className="flex h-[378px] md:h-[auto] items-start justify-start max-w-[913px] py-[16px] w-[100%]">
                    <div className="bg-white_A700 flex flex-col gap-[16px] h-[100%] items-center justify-center px-[16px] py-[24px] rounded-[8px] shadow-bs w-[100%]">
                      <div className="h-[174px] relative w-[174px]">
                        ...
                        />
                        <Img
                          src="images/img_imagem_174x174.png"
                      ...
                      <div className="flex items-start justify-start w-[auto]">
                        <Text
                          ...
                          variant="h5"
                        >
                          Você não tem uma compra recorrente
                        </Text>
                      </div>
                      <Text
                        ...
                        variant="body2"
                      >
                        Finalize um pedido com produtos recorrentes para
                        visualizar aqui
                      </Text>
                ...
                <div className="flex items-start justify-start max-w-[1056px] w-[100%]">
                  <div className="flex h-[176px] md:h-[auto] items-start justify-start max-w-[1056px] overflow-auto w-[100%]">
              ...
              <div className="bg-teal_800 flex h-[56px] md:h-[auto] items-center justify-center md:ml-[0] ml-[749px] mr-[120px] px-[16px] py-[14px] rounded-[28px] shadow-bs2 w-[auto]">
...
export default DesktopRePillInformaesEmptystatePage;
