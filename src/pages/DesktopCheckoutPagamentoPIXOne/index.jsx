...
const DesktopCheckoutPagamentoPIXOnePage = () => {
          ...
          <div className="flex md:flex-col flex-row gap-[16px] items-center justify-center max-w-[936px] mt-[16px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="bg-white_A700 flex sm:flex-1 flex-col gap-[16px] h-[370px] md:h-[auto] items-center justify-center pt-[24px] rounded-[8px] shadow-bs sm:w-[100%] w-[555px]">
              ...
              <Text
                ...
                variant="h5"
              >
                Tempo de PIX esgotado
              </Text>
              <Text
                className="font-normal leading-[150.00%] not-italic text-bluegray_500 text-center"
                variant="body2"
              >
                Gere um novo código de pagamento via PIX ou selecione um <br />
                novo método de pagamento para finalizar a sua compra.
              </Text>
              <Input
...
export default DesktopCheckoutPagamentoPIXOnePage;
