...
const DesktopRePillGerenciarPularentregaPage = () => {
  return (
    <>
      <div className="bg-gray_100 flex font-rubik h-[1203px] justify-end mx-[auto] relative w-[100%]">
        <div className="h-[1506px] mt-[auto] mx-[auto] md:px-[20px] w-[100%]">
          <div className="flex md:flex-col flex-row md:gap-[20px] h-[100%] items-start justify-evenly m-[auto] w-[100%]">
            <div className="md:h-[1288px] h-[1506px] sm:h-[948px] relative md:w-[100%] w-[78%]">
              <Img
                src="images/img_ellipse14_713x356.png"
            ...
            <div className="flex md:flex-1 flex-col md:gap-[40px] gap-[846px] justify-start md:w-[100%] w-[23%]">
              <Img
                src="images/img_ellipse15_102x199.png"
        ...
        <div className="absolute bg-bluegray_900_33 flex inset-x-[0] items-center justify-start mx-[auto] p-[243px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
          <div className="bg-white_A700 flex flex-col items-start justify-start mb-[198px] md:px-[20px] rounded-[8px] shadow-bs2 sm:w-[100%] w-[555px]">
              ...
              <div className="flex items-center justify-center pt-[16px] w-[100%]">
                ...
                >
                  <span className="text-bluegray_800 text-[14px] font-rubik">
                    Não precisa desse item no momento? Tudo bem, você pode pular
                    a entrega dele, confirmando no botão abaixo. Mas atenção:
                  </span>
                  <span className="text-bluegray_800 text-[14px] font-rubik font-semibold">
                    {" "}
                    essa ação não poderá ser desfeita, ok?
                  </span>
                </Text>
              </div>
              <div className="flex sm:flex-col flex-row gap-[16px] items-start justify-start w-[100%]">
                <div className="flex flex-1 h-[44px] md:h-[auto] items-center justify-center rounded-[22px] w-[100%]">
                ...
                <div className="bg-indigo_900 flex flex-1 h-[44px] md:h-[auto] items-center justify-center px-[16px] py-[14px] rounded-[22px] w-[100%]">
                  <div className="flex items-center justify-start w-[auto]">
                    <div className="flex items-center justify-center w-[auto]">
                      <Text
...
export default DesktopRePillGerenciarPularentregaPage;
