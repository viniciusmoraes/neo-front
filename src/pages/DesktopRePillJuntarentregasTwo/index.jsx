...
const DesktopRePillJuntarentregasTwoPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_100 flex flex-col font-rubik gap-[16px] items-center justify-start mx-[auto] w-[100%]">
        ...
        <div className="h-[1462px] sm:h-[817px] md:h-[878px] md:px-[20px] relative w-[100%]">
          <Img
            src="images/img_group151.png"
            className="absolute h-[451px] object-cover right-[0] top-[2%] w-[auto]"
            alt="Group151"
          />
          <div className="absolute bottom-[0] h-[1307px] sm:h-[817px] md:h-[878px] inset-x-[0] mx-[auto] w-[100%]">
            <Img
              src="images/img_group149.png"
              className="absolute bottom-[0] h-[817px] left-[0] object-cover w-[auto]"
              alt="Group149"
            />
            ...
            <div className="absolute bg-teal_800 bottom-[26%] flex h-[56px] md:h-[auto] items-center justify-center px-[16px] py-[14px] right-[9%] rounded-[28px] shadow-bs2 w-[auto]">
            ...
            <div className="absolute flex flex-col gap-[16px] inset-x-[0] items-end justify-start max-w-[746px] mx-[auto] top-[0] w-[100%]">
              ...
              <div className="bg-white_A700 flex flex-col gap-[8px] items-center justify-start pb-[16px] px-[16px] rounded-[8px] shadow-bs w-[100%]">
                ...
                <div className="flex flex-col gap-[8px] items-start justify-start w-[100%]">
                  ...
                  <div className="bg-white_A700 border-[1px] border-gray_300 border-solid flex h-[116px] md:h-[auto] items-center justify-center p-[16px] rounded-[8px] w-[100%]">
                    <div className="flex h-[56px] md:h-[auto] items-center justify-center px-[16px] py-[14px] rounded-[28px] shadow-bs2 w-[100%]">
...
export default DesktopRePillJuntarentregasTwoPage;
