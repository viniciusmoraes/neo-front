...
const DesktopRePillJuntarentregasPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_100 flex flex-col font-rubik gap-[16px] items-center justify-start mx-[auto] w-[100%]">
        ...
        <div className="h-[1462px] sm:h-[871px] md:h-[878px] md:px-[20px] relative w-[100%]">
          <Img
            src="images/img_group151.png"
            className="absolute h-[451px] object-cover right-[0] top-[2%] w-[auto]"
            alt="Group151"
          />
          <div className="absolute bottom-[0] h-[1307px] sm:h-[871px] md:h-[878px] inset-x-[0] mx-[auto] w-[100%]">
            <Img
...
export default DesktopRePillJuntarentregasPage;
