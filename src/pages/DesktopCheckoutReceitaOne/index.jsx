...
const DesktopCheckoutReceitaOnePage = () => {
  const [inputvalue, setInputvalue] = React.useState("");

  return (
    <>
      <div className="bg-gray_50 flex flex-col font-rubik gap-[16px] items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col gap-[16px] items-center justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row md:gap-[20px] h-[52px] md:h-[auto] items-start justify-center max-w-[746px] md:px-[20px] w-[100%]">
        ...
        <div className="h-[1509px] md:h-[847px] md:px-[20px] relative w-[100%]">
          <Img
            src="images/img_group151.png"
            className="absolute h-[451px] object-cover right-[0] top-[4%] w-[auto]"
            alt="Group151"
          />
          <div className="absolute bottom-[0] h-[1272px] md:h-[847px] inset-x-[0] mx-[auto] w-[100%]">
            <Img
              src="images/img_group149.png"
              className="absolute bottom-[0] h-[847px] left-[0] object-cover w-[auto]"
              alt="Group149"
            />
            ...
            <div className="absolute bottom-[38%] flex flex-col gap-[12px] inset-x-[0] items-center justify-start max-w-[746px] mx-[auto] w-[100%]">
              ...
              <Input
                ...
                wrapClassName="flex max-w-[746px] md:h-[auto] sm:h-[auto] w-[100%]"
                name="Sim"
                placeholder="Sim"
                prefix={
                  <Img
            ...
            <div className="absolute flex inset-x-[0] items-center justify-start mx-[auto] top-[0] w-[55%]">
              <div className="flex flex-col items-start justify-start w-[100%]">
                <div className="flex items-start justify-start pb-[16px] pt-[8px] w-[auto]">
                  <Text
                    className="text-bluegray_900 text-left w-[auto]"
            ...
            <div className="absolute bg-indigo_900 bottom-[16%] flex h-[44px] md:h-[auto] inset-x-[0] items-center justify-center mx-[auto] px-[16px] py-[14px] rounded-[22px] w-[269px]">
              <div className="flex items-center justify-start w-[auto]">
                <div className="flex items-center justify-center px-[4px] w-[auto]">
                  <Text
                    className="font-medium text-left text-light_green_A200 w-[auto]"
          ...
          <div className="absolute flex flex-col gap-[16px] inset-x-[0] items-start justify-start mx-[auto] top-[0] w-[55%]">
            ...
            <List
              className="bg-white_A700 flex-col gap-[24px] grid items-start max-w-[746px] p-[16px] rounded-[8px] shadow-bs w-[100%]"
              orientation="vertical"
            >
              <div className="flex flex-1 items-end justify-start my-[0] w-[100%]">
                <div className="flex items-start justify-start w-[100%]">
...
export default DesktopCheckoutReceitaOnePage;
